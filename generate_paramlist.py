...
def main():
    ...
    paramlist_defaults['turbulence']['EDMF_PrognosticTKE']['tke_ed_coeff'] = 0.13 # 0.14
    paramlist_defaults['turbulence']['EDMF_PrognosticTKE']['tke_diss_coeff'] = 0.23#0.22
    paramlist_defaults['turbulence']['EDMF_PrognosticTKE']['static_stab_coeff'] = 0.5 # 0.4
    ...
    paramlist_defaults['turbulence']['EDMF_PrognosticTKE']['entrainment_factor'] = 0.14
    paramlist_defaults['turbulence']['EDMF_PrognosticTKE']['detrainment_factor'] = 0.58
    ...
    paramlist_defaults['turbulence']['EDMF_PrognosticTKE']['entrainment_sigma'] = 7.0
    ...
    paramlist_defaults['turbulence']['EDMF_PrognosticTKE']['pressure_normalmode_drag_coeff'] = 5.2
