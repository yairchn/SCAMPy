...
cdef class SimilarityED(ParameterizationBase):
    ...
    cpdef update(self,GridMeanVariables GMV, CasesBase Case, TimeStepping TS ):
        ...
        with nogil:
            ...
            x[0] = x[0] + TS.dt * Case.Sur.rho_qtflux * self.Gr.dzi_half[gw] * self.Ref.alpha0_half[gw]
        ...
        with nogil:
            ...
            x[0] = x[0] + TS.dt * Case.Sur.rho_hflux * self.Gr.dzi_half[gw] * self.Ref.alpha0_half[gw]
        ...
        with nogil:
            ...
            x[0] = x[0] + TS.dt * Case.Sur.rho_uflux * self.Gr.dzi_half[gw] * self.Ref.alpha0_half[gw]
        ...
        with nogil:
            ...
            x[0] = x[0] + TS.dt * Case.Sur.rho_vflux * self.Gr.dzi_half[gw] * self.Ref.alpha0_half[gw]
