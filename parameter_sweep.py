...
def main():
    ...
    lwp = grp_stats.createVariable('lwp', 'f4', ('t', 'var_n', 'var_m'))
    cloud_cover = grp_stats.createVariable('cloud_cover', 'f4', ('t', 'var_n','var_m'))
    cloud_top = grp_stats.createVariable('cloud_top', 'f4', ('t', 'var_n','var_m'))
    cloud_base = grp_stats.createVariable('cloud_base', 'f4', ('t', 'var_n','var_m'))
    updraft_area = grp_stats.createVariable('updraft_area', 'f4', ('t', 'z','var_n','var_m'))
    ql_mean = grp_stats.createVariable('ql_mean', 'f4', ('t', 'z', 'var_n','var_m'))
    qt_mean = grp_stats.createVariable('qt_mean', 'f4', ('t', 'z', 'var_n','var_m'))
    temperature_mean = grp_stats.createVariable('temperature_mean', 'f4', ('t', 'z', 'var_n','var_m'))
    RH_mean = grp_stats.createVariable('RH_mean', 'f4', ('t', 'z', 'var_n','var_m'))
    updraft_w = grp_stats.createVariable('updraft_w', 'f4', ('t', 'z', 'var_n','var_m'))
    thetal_mean = grp_stats.createVariable('thetal_mean', 'f4', ('t', 'z', 'var_n','var_m'))
    buoyancy_mean = grp_stats.createVariable('buoyancy_mean', 'f4', ('t', 'z', 'var_n','var_m'))
    massflux = grp_stats.createVariable('massflux', 'f4', ('t', 'z', 'var_n','var_m'))
    env_tke = grp_stats.createVariable('env_tke', 'f4', ('t', 'z', 'var_n','var_m'))
    updraft_thetal_precip = grp_stats.createVariable('updraft_thetal_precip', 'f4', ('t', 'z', 'var_n','var_m'))
