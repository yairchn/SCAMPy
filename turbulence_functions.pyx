...
cdef entr_struct entr_detr_inverse_w(entr_in_struct entr_in) nogil:
    ...
    eps_w = 1.0/(fmax(entr_in.w,1.0)*500.0)
    ...
    if entr_in.af>0.0:
        partiation_func  = entr_detr_buoyancy_sorting1(entr_in)
        #partiation_func = entr_in.normalized_skew
        #with gil:
        #    print partiation_func
        _ret.entr_sc = (partiation_func)*eps_w/2.0 # - entr_in.normalized_skew/1000.0
